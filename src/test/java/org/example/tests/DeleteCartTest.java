...
public class DeleteCartTest extends BaseTest {
    ...
    public void testDeleteFromMulti() {
        ...
        addProductToCartDirect(10, "\u0110en", "S");

        String response = postCartUpdate("{\"product_id\":7,\"color\":\"Xanh \\u0111en\",\"size\":\"S\",\"action\":\"delete\"}");
    ...
    public void testDeleteOnlyItem() {
        ...
        String response = postCartUpdate("{\"product_id\":10,\"color\":\"\\u0110en\",\"size\":\"S\",\"action\":\"delete\"}");
        Assert.assertTrue(response.contains("\"success\":true") || response.contains("\"success\": true"),
